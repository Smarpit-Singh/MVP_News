package com.example.devsmar.simplemvpnews.utils;

import android.text.TextUtils;

import com.example.devsmar.simplemvpnews.mvp.model.Articles;
import com.example.devsmar.simplemvpnews.mvp.model.Response;
...
public class NetworkError extends Throwable {
    ...
    protected String getJsonStringFromResponse(final retrofit2.Response<?> response) {
        try {
            ...
            Articles errorResponse = new Gson().fromJson(jsonString, Articles.class);
